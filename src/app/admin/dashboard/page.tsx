...
export default function AdminDashboard() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
          // Note: using fetch with FormData automatically sets Content-Type to multipart/form-data
          // However, our API expects this. For PUT, standard FormData works often but sometimes 
          // JSON is preferred. Let's stick to FormData as implemented in API routes previously.
